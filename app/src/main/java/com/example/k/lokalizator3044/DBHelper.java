...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public final static String BD_ADDRESS = "macAddress";
    ...
    //ifen
    public final static String CREATE_BASE = "CREATE TABLE "+ TABLE_NAME +"("+ID+" integer primary key autoincrement, "+ BD_ADDRESS +" text not null, "+ NAME +" text not null, "+ WORKING_MODE +" text not null, "+ RINGTONE +" text not null, "+ DISTANCE +" text not null, "+ CLICK +" text not null, "+ DOUBLE_CLICK +" text not null);";
